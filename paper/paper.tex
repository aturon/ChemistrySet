...
To make this discussion concrete, we give a classic example of a fine-grained
concurrent data structure: Treiber's lock-free stack~\cite{?}, shown in
\figref{classic-treiber}.
...
%% For example, containers like
%% stacks and queues provide communication; contructs like locks and
%% barriers provide synchronization; and (synchronous) message channels
%% provide both.
...
shared pointer directly.  Scalability can be further improved by 
