...
than lock-freemdom~\cite{?}.  %Work in the area is
...
operations\elide{; we know of no STM implementation that can provide similar
  guarantees or a similar cost model}.  Yet, unlike hand-written algorithms,
reagents can be tailored and composed using choice, adding blocking behavior,
or combining sequentially into larger atomic blocks. %TODO
...
resembles the work on Communicating Transactions.   %TODO
