...
Reagents are a new instance of an old idea: representing computations
as data.  In this case, the computations being represented are
...
\subsection{Reagents by example}
